...
if __name__ == "__main__":
    ...
    results["gold_31_1023_rel_freqs"] = np.linspace(-6e3, 6e3, 100) * 2
    ...
    results["gold_300_1023_rel_freqs"] = np.linspace(-29.6e3, 29.6e3, 100) * 2
    ...
    results["weil_31_10230_rel_freqs"] = np.linspace(-4.5e3, 4.5e3, 100) * 2
